...
# 📖 hello_world_frontend <a name="about-project"></a>

**hello_world_frontend** is app build using react js.
...
```sh
  cd my-folder
  https://github.com/jeanbuhendwa/hello_world_frontend.git
```
...
You can access the backend PR using the below link

[Here...](https://github.com/jeanbuhendwa/hello-rails-back-end/pull/1)
